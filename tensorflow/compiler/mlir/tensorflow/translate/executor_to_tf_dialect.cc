...
namespace {
struct ExecutorToTFDialectConversion
    : public PassWrapper<ExecutorToTFDialectConversion, FunctionPass> {
...
void ExecutorToTFDialectConversion::runOnFunction() {
...
CreateTFExecutorToTFDialectConversion() {
  return std::make_unique<ExecutorToTFDialectConversion>();
}

}  // namespace mlir

static mlir::PassRegistration<mlir::ExecutorToTFDialectConversion> pass(
    "tf-executor-to-tf-conversion",
