...
// 4) bazel-bin/tensorflow/compiler/mlir/tf-opt -tf-executor-to-tf-conversion -tf-executor-to-tf-conversion --xla-legalize-tf  -hlo-legalize-to-lhlo --lhlo-legalize-to-std  --convert-std-to-llvm  tensorflow/compiler/mlir/tensorflow/tests/mlir_runtime_input_args.mlir | bazel-bin/tensorflow/compiler/mlir/tensorflow/tf-mlir-runtime -e main_1d_i64 -entry-point-result=user_define -shared-libs=bazel-bin/tensorflow/compiler/mlir/libtf_mlir_compiler_util.so
